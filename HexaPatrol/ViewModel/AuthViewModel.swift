...
//    static let url = URL(string: "http://192.168.18.31:8000/api/")!
    ...
    //Office HOME56
    //    static let url = URL(string: "http://192.168.1.37:8000/api/")!
    
    static let url = URL(string: "http://192.168.18.96:8000/api/")!
#endif
    ...
    static var cantPatrolRequest: URL { return url.appendingPathComponent("cant-patrol") }
    }
    ...
    class AuthViewModel: ObservableObject {
        ...
        private let cantPatrolURL = BaseURL.cantPatrolRequest
